...
/* blk range is 0-1f, Data size range is 1 to 32 */
#define DBG_DATA_ENCODE_SIZE(blk, size) \
	((blk << DBG_DATA_BLK_IDX_OFFSET) | size)
#define DBG_DATA_MAX_SIZE 32
...
struct drv_func_mb {
	...
	#define DRV_MSG_CODE_DBG_BUF_OFFSET_REQ		0xe5000000
	#define DRV_MSG_CODE_DEBUG_DATA_SEND		0xe5100000
	...
	#define	FW_MSG_CODE_DEBUG_DATA_SEND_INV_ARG	0xe4100000
	#define FW_MSG_CODE_DEBUG_DATA_SEND_BUF_FULL	0xe4200000
	#define FW_MSG_CODE_DEBUG_NOT_ENABLED		0xe4300000
	#define FW_MSG_CODE_DEBUG_ENABLED		0xe4400000
	#define FW_MSG_CODE_DEBUG_DATA_SEND_OK		0xe4000000
...
struct pf_vlan_table {
	...
	u8 pcp;
	u8 rsvd;
	u8 trunk_vlan_bitmap[VLAN_BITMAP_SIZE];
	u32 rsvd1[4];
};
...
struct vlan_table_s {
	...
	u8 vlan_mode[NVM_PATH_MAX][PORT_MAX];
