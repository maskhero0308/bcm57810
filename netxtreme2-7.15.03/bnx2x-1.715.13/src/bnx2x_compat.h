...
#define bnx2x_esx_tx_error(bp)
#define bnx2x_esx_parity_error(bp) 0
#define BNX2X_ESX_TRIGGER_TX_TO(bp, err)
#define ESX_CXT_PARITY_TRIGGER 1
#define ESX_CXT_TXTO_TRIGGER 2
#define ESX_CXT_STSTO_TRIGGER 3
#define ESX_ERR_TXQ_STUCK       0x1
#define ESX_ERR_NETDEV_TO       0x2
#define ESX_ERR_PARITY          0x4
#define ESX_ERR_STATS_TO        0x8
#define ESX_ERR_MC_ASSERT       0x10
#define ESX_ERR_PANIC           0x20
#define ESX_ERR_MCP_ASSERT      0x40
...
#define pci_channel_offline(pdev) false
#endif
...
#if ((defined(RHEL_RELEASE_CODE) && (RHEL_RELEASE_CODE <= RHEL_RELEASE_VERSION(5, 11))) || (defined(SLES_DISTRO) && (SLES_DISTRO <= 0x1004)))
...
#if defined(_DEFINE_CHANNEL_OFFLINE)
#define pci_channel_offline(pdev) false
#endif
...
#if defined(_DEFINE_ETH_RANDOM_ADDR)
...
#ifdef _DEFINE_TC_SETUP_QDISC_MQPRIO
