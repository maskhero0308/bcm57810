...
#endif
#include <net/tcp.h>
#if defined(CONFIG_BNX2X_VXLAN) || defined(_HAS_NDO_UDP_TUNNEL_CONFIG) || defined(_HAS_NDO_EXT_UDP_TUNNEL_CONFIG) /* BNX2X_UPSTREAM */
#include <net/vxlan.h>
#endif
...
#if defined(CONFIG_BNX2X_GENEVE) /* BNX2X_UPSTREAM */
...
#if  defined(__VMKLNX__) /* ! BNX2X_UPSTREAM */
uint tx_to_delay = 5;
module_param(tx_to_delay, uint, 0);
MODULE_PARM_DESC(tx_to_delay, "Time interval (in seconds) to wait for before considering a Tx queue stuck and triggering a tx timeout. Default:5, Disable:0 (use netdev tx timeout), Minimum:5");
uint auto_recovery = 1;
module_param(auto_recovery, uint, 0);
MODULE_PARM_DESC(auto_recovery, "Automatically recover interface after detecting/inducing hardware error. Enable: 1, Disable:0, Default:1");
#else
...
static uint full_promiscous;
module_param(full_promiscous, uint, 0644);
MODULE_PARM_DESC(full_promiscous,
		 " Accept unmatched unicast packets (Disabled default)");
#endif
...
static int int_mode;
#else
static enum bnx2x_int_mode int_mode;
#endif
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 0)) /* BNX2X_UPSTREAM */
...
static _UP_UINT2INT int_debug = BNX2X_DEF_INT_MSG_LEVEL;
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 0)) /* BNX2X_UPSTREAM */
module_param(int_debug, _UP_UINT2INT, 0);
MODULE_PARM_DESC(int_debug, " Default internal debug msglevel");
#endif

static _UP_UINT2INT int_debug_size = BNX2X_DEF_INT_DBG_BUF_SIZE;
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 0)) /* BNX2X_UPSTREAM */
module_param(int_debug_size, _UP_UINT2INT, 0);
MODULE_PARM_DESC(int_debug_size, " Default internal debug buffer size");
#endif
...
uint use_random_vf_mac;
module_param(use_random_vf_mac, uint, 0);
MODULE_PARM_DESC(use_random_vf_mac, "When set, all VFs would be configured with a default immutable MAC");

uint allow_vf_mac_change_mode = 0;
module_param(allow_vf_mac_change_mode, uint, S_IRUGO);
MODULE_PARM_DESC(allow_vf_mac_change_mode, "Allow VF to change MAC address despite PF sets force MAC (0 Disable (default); 1 Enable))");
#endif
...
static int fairness_threshold;
module_param(fairness_threshold, uint, 0644);
MODULE_PARM_DESC(fairness_threshold, "When set to '1' will enable the fairness threshold; 0 by Default");

static int intr_mitigation;
module_param(intr_mitigation, uint, 0644);
MODULE_PARM_DESC(intr_mitigation, "When set to '1' will enable the interrupt mitigation; 0 by Default");
...
struct bnx2x_intr_map {
	unsigned int intr;
	unsigned int mask;
	unsigned int clr;
};

static struct bnx2x_intr_map intr_map[] = {
	{ATC_REG_ATC_INT_STS, ATC_REG_ATC_INT_MASK, ATC_REG_ATC_INT_STS_CLR},
	{BRB1_REG_BRB1_INT_STS, BRB1_REG_BRB1_INT_MASK, BRB1_REG_BRB1_INT_STS_CLR},
	{CCM_REG_CCM_INT_STS, CCM_REG_CCM_INT_MASK, CCM_REG_CCM_INT_STS_CLR},
	{CDU_REG_CDU_INT_STS, CDU_REG_CDU_INT_MASK, CDU_REG_CDU_INT_STS_CLR},
	{CFC_REG_CFC_INT_STS, CFC_REG_CFC_INT_MASK, CFC_REG_CFC_INT_STS_CLR},
	{CSDM_REG_CSDM_INT_STS_0, CSDM_REG_CSDM_INT_MASK_0, CSDM_REG_CSDM_INT_STS_CLR_0},
	{CSDM_REG_CSDM_INT_STS_1, CSDM_REG_CSDM_INT_MASK_1, CSDM_REG_CSDM_INT_STS_CLR_1},
	{CSEM_REG_CSEM_INT_STS_0, CSEM_REG_CSEM_INT_MASK_0, CSEM_REG_CSEM_INT_STS_CLR_0},
	{CSEM_REG_CSEM_INT_STS_1, CSEM_REG_CSEM_INT_MASK_1, CSEM_REG_CSEM_INT_STS_CLR_1},
	{DBG_REG_DBG_INT_STS, DBG_REG_DBG_INT_MASK, DBG_REG_DBG_INT_STS_CLR},
	{DMAE_REG_DMAE_INT_STS, DMAE_REG_DMAE_INT_MASK, DMAE_REG_DMAE_INT_STS_CLR},
	{DORQ_REG_DORQ_INT_STS, DORQ_REG_DORQ_INT_MASK, DORQ_REG_DORQ_INT_STS_CLR},
	{HC_REG_HC_INT_STS, HC_REG_HC_INT_MASK, HC_REG_HC_INT_STS_CLR},
	{IGU_REG_IGU_INT_STS, IGU_REG_IGU_INT_MASK, IGU_REG_IGU_INT_STS_CLR},
	{MISC_REG_MISC_INT_STS, MISC_REG_MISC_INT_MASK, MISC_REG_MISC_INT_STS_CLR},
	{MSTAT_REG_MSTAT_INT_STS, MSTAT_REG_MSTAT_INT_MASK, MSTAT_REG_MSTAT_INT_STS_CLR},
	{NIG_REG_NIG_INT_STS_0, NIG_REG_NIG_INT_MASK_0, NIG_REG_NIG_INT_STS_CLR_0},
	{NIG_REG_NIG_INT_STS_1, NIG_REG_NIG_INT_MASK_1, NIG_REG_NIG_INT_STS_CLR_1},
	{NIG_TSGEN_REG_NIG_TSGEN_INT_STS, NIG_TSGEN_REG_NIG_TSGEN_INT_MASK, NIG_TSGEN_REG_NIG_TSGEN_INT_STS_CLR},
	{PBF_REG_PBF_INT_STS, PBF_REG_PBF_INT_MASK, PBF_REG_PBF_INT_STS_CLR},
	{PB_REG_PB_INT_STS, PB_REG_PB_INT_MASK, PB_REG_PB_INT_STS_CLR},
	{PGLUE_B_REG_PGLUE_B_INT_STS, PGLUE_B_REG_PGLUE_B_INT_MASK, PGLUE_B_REG_PGLUE_B_INT_STS_CLR},
	{PRS_REG_PRS_INT_STS, PRS_REG_PRS_INT_MASK, PRS_REG_PRS_INT_STS_CLR},
	{PXP2_REG_PXP2_INT_STS_0, PXP2_REG_PXP2_INT_MASK_0, PXP2_REG_PXP2_INT_STS_CLR_0},
	{PXP2_REG_PXP2_INT_STS_1, PXP2_REG_PXP2_INT_MASK_1, PXP2_REG_PXP2_INT_STS_CLR_1},
	{PXP_REG_PXP_INT_STS_0, PXP_REG_PXP_INT_MASK_0, PXP_REG_PXP_INT_STS_CLR_0},
	{PXP_REG_PXP_INT_STS_1, PXP_REG_PXP_INT_MASK_1, PXP_REG_PXP_INT_STS_CLR_1},
	{QM_REG_QM_INT_STS, QM_REG_QM_INT_MASK, QM_REG_QM_INT_STS_CLR},
	{SEM_FAST_REG_SEM_FAST_INT_STS, SEM_FAST_REG_SEM_FAST_INT_MASK, SEM_FAST_REG_SEM_FAST_INT_STS_CLR},
	{SRC_REG_SRC_INT_STS, SRC_REG_SRC_INT_MASK, SRC_REG_SRC_INT_STS_CLR},
	{TCM_REG_TCM_INT_STS, TCM_REG_TCM_INT_MASK, TCM_REG_TCM_INT_STS_CLR},
	{TM_REG_TM_INT_STS, TM_REG_TM_INT_MASK, TM_REG_TM_INT_STS_CLR},
	{TSDM_REG_TSDM_INT_STS_0, TSDM_REG_TSDM_INT_MASK_0, TSDM_REG_TSDM_INT_STS_CLR_0},
	{TSDM_REG_TSDM_INT_STS_1, TSDM_REG_TSDM_INT_MASK_1, TSDM_REG_TSDM_INT_STS_CLR_1},
	{TSEM_REG_TSEM_INT_STS_0, TSEM_REG_TSEM_INT_MASK_0, TSEM_REG_TSEM_INT_STS_CLR_0},
	{TSEM_REG_TSEM_INT_STS_1, TSEM_REG_TSEM_INT_MASK_1, TSEM_REG_TSEM_INT_STS_CLR_1},
	{UCM_REG_UCM_INT_STS, UCM_REG_UCM_INT_MASK, UCM_REG_UCM_INT_STS_CLR},
	{USDM_REG_USDM_INT_STS_0, USDM_REG_USDM_INT_MASK_0, USDM_REG_USDM_INT_STS_CLR_0},
	{USDM_REG_USDM_INT_STS_1, USDM_REG_USDM_INT_MASK_1, USDM_REG_USDM_INT_STS_CLR_1},
	{USEM_REG_USEM_INT_STS_0, USEM_REG_USEM_INT_MASK_0, USEM_REG_USEM_INT_STS_CLR_0},
	{USEM_REG_USEM_INT_STS_1, USEM_REG_USEM_INT_MASK_1, USEM_REG_USEM_INT_STS_CLR_1},
	{VFC_REG_VFC_INT_STS, VFC_REG_VFC_INT_MASK, VFC_REG_VFC_INT_STS_CLR},
	{XCM_REG_XCM_INT_STS, XCM_REG_XCM_INT_MASK, XCM_REG_XCM_INT_STS_CLR},
	{XSDM_REG_XSDM_INT_STS_0, XSDM_REG_XSDM_INT_MASK_0, XSDM_REG_XSDM_INT_STS_CLR_0},
	{XSDM_REG_XSDM_INT_STS_1, XSDM_REG_XSDM_INT_MASK_1, XSDM_REG_XSDM_INT_STS_CLR_1},
	{XSEM_REG_XSEM_INT_STS_0, XSEM_REG_XSEM_INT_MASK_0, XSEM_REG_XSEM_INT_STS_CLR_0},
	{XSEM_REG_XSEM_INT_STS_1, XSEM_REG_XSEM_INT_MASK_1, XSEM_REG_XSEM_INT_STS_CLR_1},
	{ATC_REG_ATC_PRTY_STS, ATC_REG_ATC_PRTY_MASK, ATC_REG_ATC_PRTY_STS_CLR},
	{BRB1_REG_BRB1_PRTY_STS, BRB1_REG_BRB1_PRTY_MASK, BRB1_REG_BRB1_PRTY_STS_CLR},
	{CCM_REG_CCM_PRTY_STS, CCM_REG_CCM_PRTY_MASK, CCM_REG_CCM_PRTY_STS_CLR},
	{CDU_REG_CDU_PRTY_STS, CDU_REG_CDU_PRTY_MASK, CDU_REG_CDU_PRTY_STS_CLR},
	{CFC_REG_CFC_PRTY_STS, CFC_REG_CFC_PRTY_MASK, CFC_REG_CFC_PRTY_STS_CLR},
	{CSDM_REG_CSDM_PRTY_STS, CSDM_REG_CSDM_PRTY_MASK, CSDM_REG_CSDM_PRTY_STS_CLR},
	{CSEM_REG_CSEM_PRTY_STS_0, CSEM_REG_CSEM_PRTY_MASK_0, CSEM_REG_CSEM_PRTY_STS_CLR_0},
	{CSEM_REG_CSEM_PRTY_STS_1, CSEM_REG_CSEM_PRTY_MASK_1, CSEM_REG_CSEM_PRTY_STS_CLR_1},
	{DBG_REG_DBG_PRTY_STS, DBG_REG_DBG_PRTY_MASK, DBG_REG_DBG_PRTY_STS_CLR},
	{DMAE_REG_DMAE_PRTY_STS, DMAE_REG_DMAE_PRTY_MASK, DMAE_REG_DMAE_PRTY_STS_CLR},
	{DORQ_REG_DORQ_PRTY_STS, DORQ_REG_DORQ_PRTY_MASK, DORQ_REG_DORQ_PRTY_STS_CLR},
	{HC_REG_HC_PRTY_STS, HC_REG_HC_PRTY_MASK, HC_REG_HC_PRTY_STS_CLR},
	{IGU_REG_IGU_PRTY_STS, IGU_REG_IGU_PRTY_MASK, IGU_REG_IGU_PRTY_STS_CLR},
	{MISC_REG_MISC_PRTY_STS, MISC_REG_MISC_PRTY_MASK, MISC_REG_MISC_PRTY_STS_CLR},
	{NIG_REG_NIG_PRTY_STS_0, NIG_REG_NIG_PRTY_MASK_0, NIG_REG_NIG_PRTY_STS_CLR_0},
	{NIG_REG_NIG_PRTY_STS_1, NIG_REG_NIG_PRTY_MASK_1, NIG_REG_NIG_PRTY_STS_CLR_1},
	{NIG_REG_NIG_PRTY_STS, NIG_REG_NIG_PRTY_MASK, NIG_REG_NIG_PRTY_STS_CLR},
	{PBF_REG_PBF_PRTY_STS, PBF_REG_PBF_PRTY_MASK, PBF_REG_PBF_PRTY_STS_CLR},
	{PB_REG_PB_PRTY_STS, PB_REG_PB_PRTY_MASK, PB_REG_PB_PRTY_STS_CLR},
	{PGLUE_B_REG_PGLUE_B_PRTY_STS, PGLUE_B_REG_PGLUE_B_PRTY_MASK, PGLUE_B_REG_PGLUE_B_PRTY_STS_CLR},
	{PRS_REG_PRS_PRTY_STS, PRS_REG_PRS_PRTY_MASK, PRS_REG_PRS_PRTY_STS_CLR},
	{PXP2_REG_PXP2_PRTY_STS_0, PXP2_REG_PXP2_PRTY_MASK_0, PXP2_REG_PXP2_PRTY_STS_CLR_0},
	{PXP2_REG_PXP2_PRTY_STS_1, PXP2_REG_PXP2_PRTY_MASK_1, PXP2_REG_PXP2_PRTY_STS_CLR_1},
	{PXP_REG_PXP_PRTY_STS, PXP_REG_PXP_PRTY_MASK, PXP_REG_PXP_PRTY_STS_CLR},
	{QM_REG_QM_PRTY_STS, QM_REG_QM_PRTY_MASK, QM_REG_QM_PRTY_STS_CLR},
	{SEM_FAST_REG_SEM_FAST_PRTY_STS, SEM_FAST_REG_SEM_FAST_PRTY_MASK, SEM_FAST_REG_SEM_FAST_PRTY_STS_CLR},
	{SRC_REG_SRC_PRTY_STS, SRC_REG_SRC_PRTY_MASK, SRC_REG_SRC_PRTY_STS_CLR},
	{TCM_REG_TCM_PRTY_STS, TCM_REG_TCM_PRTY_MASK, TCM_REG_TCM_PRTY_STS_CLR},
	{TM_REG_TM_PRTY_STS, TM_REG_TM_PRTY_MASK, TM_REG_TM_PRTY_STS_CLR},
	{TSDM_REG_TSDM_PRTY_STS, TSDM_REG_TSDM_PRTY_MASK, TSDM_REG_TSDM_PRTY_STS_CLR},
	{TSEM_REG_TSEM_PRTY_STS_0, TSEM_REG_TSEM_PRTY_MASK_0, TSEM_REG_TSEM_PRTY_STS_CLR_0},
	{TSEM_REG_TSEM_PRTY_STS_1, TSEM_REG_TSEM_PRTY_MASK_1, TSEM_REG_TSEM_PRTY_STS_CLR_1},
	{UCM_REG_UCM_PRTY_STS, UCM_REG_UCM_PRTY_MASK, UCM_REG_UCM_PRTY_STS_CLR},
	{USDM_REG_USDM_PRTY_STS, USDM_REG_USDM_PRTY_MASK, USDM_REG_USDM_PRTY_STS_CLR},
	{USEM_REG_USEM_PRTY_STS_0, USEM_REG_USEM_PRTY_MASK_0, USEM_REG_USEM_PRTY_STS_CLR_0},
	{USEM_REG_USEM_PRTY_STS_1, USEM_REG_USEM_PRTY_MASK_1, USEM_REG_USEM_PRTY_STS_CLR_1},
	{VFC_REG_VFC_PRTY_STS, VFC_REG_VFC_PRTY_MASK, VFC_REG_VFC_PRTY_STS_CLR},
	{XCM_REG_XCM_PRTY_STS, XCM_REG_XCM_PRTY_MASK, XCM_REG_XCM_PRTY_STS_CLR},
	{XSDM_REG_XSDM_PRTY_STS, XSDM_REG_XSDM_PRTY_MASK, XSDM_REG_XSDM_PRTY_STS_CLR},
	{XSEM_REG_XSEM_PRTY_STS_0, XSEM_REG_XSEM_PRTY_MASK_0, XSEM_REG_XSEM_PRTY_STS_CLR_0},
	{XSEM_REG_XSEM_PRTY_STS_1, XSEM_REG_XSEM_PRTY_MASK_1, XSEM_REG_XSEM_PRTY_STS_CLR_1}
};
...
unlock:
	...
	if (rc) {
		/* Release CPU temporarily to avoid
		 * CPU lockup during recovery.
		 */
		bp->dmae_error_cnt++;
		if (bp->dmae_error_cnt >= 5) {
			if (b_can_sleep)
				msleep(1);
			else
				mdelay(1);
...
_UP_STATIC void bnx2x_int_disable(struct bnx2x *bp)
{
...
static void bnx2x_intr_mitigation(struct bnx2x *bp)
{
	u32 int_val, mask_val, clr_val;
	int i;

	BNX2X_ERR("Disabling the status and parity attentions\n");
	for (i = 0; i < sizeof(intr_map)/sizeof(struct bnx2x_intr_map); i++) {
		int_val = REG_RD(bp, intr_map[i].intr);
		mask_val = REG_RD(bp, intr_map[i].mask);
		clr_val = int_val & (~mask_val);
		DP(BNX2X_MSG_SP,
		   "Masking the Intr 0x%x: int_val = %d mask_val = %d\n",
		   intr_map[i].intr, int_val, mask_val);
		REG_WR(bp, intr_map[i].clr, clr_val);
		REG_WR(bp, intr_map[i].mask, int_val | mask_val);
	}
}
...
void bnx2x_panic_dump(struct bnx2x *bp, bool disable_int)
{
	...
	if (IS_PF(bp) && intr_mitigation)
		bnx2x_intr_mitigation(bp);
	...
	if (IS_PF(bp) && bp->dump_buff && !atomic_read(&bp->dump_done)) {
		bnx2x_dump_data(bp, (u8 *)bp->dump_buff);
		atomic_set(&bp->dump_done, 1);
		netdev_info(bp->dev,
			    "Firmware dump is stored in driver internal buffer; please save it to a file using 'ethtool -d' before system reboot\n");
	}
#endif
...
int bnx2x_send_final_clnup(struct bnx2x *bp, u8 clnup_func, u32 poll_cnt)
{
	...
	if (bnx2x_flr_clnup_reg_poll(bp, comp_addr, 1, poll_cnt) != 1) {
		...
		DP(BNX2X_MSG_SP, "At timeout completion address contained %x\n",
		   (REG_RD(bp, comp_addr)));
#if defined(__VMKLNX__) || defined(BNX2X_STOP_ON_ERROR)
		bnx2x_panic();
#endif
		return 1;
	}
...
#ifdef BNX2X_ALLOW_LB /* ! BNX2X_UPSTREAM */
static void bnx2x_set_lb_load_mode_params(struct bnx2x *bp)
{
	struct link_params *lp = &bp->link_params;
	int cfx_idx = bnx2x_get_link_cfg_idx(bp);
	int lb_mode = bp->lb_mode;

	if (lb_mode == LB_LOAD_MODE_NONE) {
		/* This probably doesn't work too well,
		 * as the state remains 'diag'. But we don't know what
		 * to put back.
		 */
		lp->loopback_mode = LOOPBACK_NONE;
		return;
	}
	...
	if (lb_mode == LB_LOAD_MODE_PHY) {
	...
	} else if (lb_mode == LB_LOAD_MODE_EXT) {
		lp->loopback_mode = LOOPBACK_EXT;
	} else if (lb_mode == LB_LOAD_MODE_MAC) {
		/* Prefer doing loopback at highest speed, if possible */
		if (lp->req_line_speed[cfx_idx] < SPEED_20000) {
			if (lp->speed_cap_mask[cfx_idx] &
			    PORT_HW_CFG_SPEED_CAPABILITY_D0_20G)
				lp->req_line_speed[cfx_idx] =
		...
		if (CHIP_IS_E3(bp)) {
			...
			if (bp->port.supported[cfg_idx] &
				...
				lp->loopback_mode = LOOPBACK_XMAC;
			else
				lp->loopback_mode = LOOPBACK_UMAC;
		} else
			lp->loopback_mode = LOOPBACK_BMAC;
	}
}
#endif
...
int bnx2x_initial_phy_init(struct bnx2x *bp, int load_mode)
{
	...
	} else if (load_mode == LOAD_LOOPBACK_EXT) {
		struct link_params *lp = &bp->link_params;
		lp->loopback_mode = LOOPBACK_EXT;
	}
	...
	if (bp->link_vars.link_up) {
		bnx2x_stats_handle(bp, STATS_EVENT_LINK_UP, true);
...
{
#ifdef BNX2X_ALLOW_LB /* ! BNX2X_UPSTREAM */
	bnx2x_set_lb_load_mode_params(bp);
#endif
	bnx2x_acquire_phy_lock(bp);
...
static void bnx2x_cmng_fns_init(struct bnx2x *bp, u8 read_cfg, u8 cmng_type)
{
	...
	if (fairness_threshold) {
		BNX2X_ERR("Configuring Fairness Thresholds\n");
		input.size_thr = 3200;
...
static void bnx2x_link_attn(struct bnx2x *bp)
{
	...
	bnx2x_stats_handle(bp, STATS_EVENT_STOP, true);
	...
	if (bp->link_vars.link_up) {
		...
		if (BNX2X_STATE_OPEN_OR_EXPLICIT_LB(bp))
			bnx2x_stats_handle(bp, STATS_EVENT_LINK_UP, true);
	}
...
#ifdef __VMKLNX__  /* ! BNX2X_UPSTREAM */
	if (bp->esx.grc_dump.flags & GRC_DMP_CLOSE_DEVICE) {
...
static void bnx2x_pmf_update(struct bnx2x *bp)
{
	...
	bnx2x_stats_handle(bp, STATS_EVENT_PMF, true);
}
				       ...
				       bool leading)
{
	...
	if (IS_MF_SD(bp) || IS_VLAN_QINQ(bp))
...
#else
	/* NOTE: If it's a FCoE queue, always enable HW VLAN stripping.
	 *	     ESX OS has a bug where they cannot handle FIP/FCOE
	 *	     frames with vlan tag.
	 *	     So, we need to ensure that all fcoe frames are devoid
	 *	     of vlan tags.
	 */
	if ((!IS_FCOE_FP(fp) && bp->vlgrp) || (IS_FCOE_FP(fp)) ||
	    IS_VLAN_QINQ(bp))
		__set_bit(BNX2X_Q_FLG_VLAN, &flags);
#endif
#else /* BNX2X_UPSTREAM */
...
#endif
#ifndef __VMKLNX__ /* BNX2X_UPSTREAM */
	/* Although in theory newer distros might manage, don't take
	 * risks and prevent FW aggregations in case of inband vlan.
	 */
	__set_bit(BNX2X_Q_FLG_TPA_VLAN_DIS, &flags);
#endif
	...
	if (IS_VLAN_FILTER(bp) && BP_PVID(bp))
		__set_bit(BNX2X_Q_FLG_SILENT_VLAN_REM, &flags);
	...
	struct bnx2x_rxq_setup_params *rxq_init)
{
	...
	if (IS_VLAN_FILTER(bp) && BP_PVID(bp)) {
		rxq_init->silent_removal_value = BP_PVID(bp);
		rxq_init->silent_removal_mask = VLAN_VID_MASK;
	}
}
...
{
	/* Workaround for MFW bug (CQ99705/CQ99787/CQ99689/CQ99234/CQ100911)
	 * regarding SF mode on Bronco and Quiz adapters
	 */
	if (!IS_MF(bp)) {
		DP(BNX2X_MSG_MCP,
...
static u32 bnx2x_update_mng_version_utility(u8 *version, bool bnx2x_format)
{
	...
	if (bnx2x_format) {
		i = sscanf(version, "%hhd.%c%hhd.%hhd",
...
#if defined(__VMKLNX__) /* ! BNX2X_UPSTREAM */
static u32 bnx2x_esx_update_mng_version_utility(u8 *version, bool bnx2x_format)
{
	u8 vals[6];
    	int i = 0;

      	i = sscanf(version, "2.%c%hhd.%hhd.%c%hhd.%hhd",
    	...
    	return (vals[0] << 24) | (vals[1] << 16) | (vals[2] << 8) | vals[5];
}
#endif
...
#if defined(__VMKLNX__) /* ! BNX2X_UPSTREAM */
	ethver = bnx2x_esx_update_mng_version_utility(DRV_MODULE_VERSION, false);
#else
		  ...
		  u32 data_hi, u32 data_lo, int cmd_type)
{
	...
	if (command != RAMROD_CMD_ID_COMMON_STAT_QUERY)
		DP(BNX2X_MSG_SP,
		   ...
		   "data (%x:%x) type(0x%x) left (CQ, EQ) (%x,%x)\n",
		   bp->spq_prod_idx, (u32)U64_HI(bp->spq_mapping),
		   (u32)(U64_LO(bp->spq_mapping) +
		   (void *)bp->spq_prod_bd - (void *)bp->spq), command, common,
		   HW_CID(bp, cid), data_hi, data_lo, type,
		   atomic_read(&bp->cq_spq_left),
		   atomic_read(&bp->eq_spq_left));
...
static void bnx2x_attn_int_deasserted3(struct bnx2x *bp, u32 attn)
{
	...
	if (attn & EVEREST_GEN_ATTN_IN_USE_MASK) {
		...
		if (attn & BNX2X_PMF_LINK_ASSERT) {
			...
			if (val & (DRV_STATUS_DCC_EVENT_MASK |
				...
				bnx2x_oem_event(bp,
					(val & (DRV_STATUS_DCC_EVENT_MASK |
						DRV_STATUS_OEM_EVENT_MASK)));
				bnx2x_schedule_sp_rtnl_delay(bp, BNX2X_SP_RTNL_OEM_EVENT, 0, 1*HZ);
			}
			...
			BNX2X_ERR("MC assert!\n");
			BNX2X_ESX_TRIGGER_TX_TO(bp, ESX_ERR_MC_ASSERT);
			bnx2x_mc_assert(bp);
			...
			BNX2X_ESX_TRIGGER_TX_TO(bp, ESX_ERR_MCP_ASSERT);
...
static void bnx2x_attn_int_deasserted(struct bnx2x *bp, u32 deasserted)
{
	...
	if (bnx2x_chk_parity_attn(bp, &global, true)) {
		...
		if (bnx2x_esx_parity_error(bp)) {
			bnx2x_release_alr(bp);
			return;
		}

#ifndef __VMKLNX__ /* BNX2X_UPSTREAM */
		bnx2x_start_recovery(bp);
#else
					    ...
					    union event_ring_elem *elem)
{
	...
	case BNX2X_FILTER_VXLAN_PENDING:
		...
		break;
#endif
	case BNX2X_FILTER_PVLAN_PENDING:
		DP(BNX2X_MSG_SP, "Got SETUP_PVLAN completions\n");
		vlan_mac_obj = &bp->sp_objs[cid].pvlan_obj;
		break;
	default:
...
static void bnx2x_eq_int(struct bnx2x *bp)
{
	...
	DP(NETIF_MSG_INTR, "EQ:  hw_cons %u  sw_cons %u bp->eq_spq_left %x\n",
...
static void bnx2x_sp_task(void *data)
{
	...
	DP(NETIF_MSG_TIMER, "sp task invoked\n");
	...
	if (atomic_read(&bp->interrupt_occurred)) {
		...
		DP(NETIF_MSG_TIMER, "status %x\n", status);
		DP(NETIF_MSG_TIMER, "setting interrupt_occurred to 0\n");
...
#if defined(__VMKLNX__) /* ! BNX2X_UPSTREAM */
/*
 * Detect whether a tx queue is stuck. If yes then stop the queue immediately to
 * cause vmkernel to issue a tx timeout. A Tx queue is considered as stuck if no
 * completion has been received for last 5 seconds or more depending upon the
 * value of module param tx_to_delay and if the pkt_cons != pkt_prod.
 */
static void bnx2x_detect_tx_hang(struct bnx2x *bp)
{
	int i;
	u8 cos;
	struct bnx2x_fp_txdata *txdata;
	...
	for_each_eth_queue(bp, i) {
		if (bp->esx.error_status)
			return;

		for_each_cos_in_tx_queue(&bp->fp[i], cos) {
			txdata = bp->fp[i].txdata_ptr[cos];
			txq = netdev_get_tx_queue(bp->dev, txdata->txq_index);

			if (txdata->tx_pkt_cons == txdata->prev_tx_pkt_cons &&
			    txdata->tx_pkt_prod != txdata->tx_pkt_cons) {

				if (txdata->queue_stuck < bp->esx.tx_to_delay) {
					txdata->queue_stuck++;
					continue;
				}

				BNX2X_ERR("Tx Queue %d stuck. tx_pkt_cons: %d, tx_pkt_prod: %d\n",
					  i, txdata->tx_pkt_cons,
					  txdata->tx_pkt_prod);

				BNX2X_ESX_TRIGGER_TX_TO(bp, ESX_ERR_TXQ_STUCK);
				break;
			}
...
#ifdef _HAS_TIMER_SETUP /* BNX2X_UPSTREAM */
static void bnx2x_timer(struct timer_list *timer)
{
	struct bnx2x *bp = container_of(timer, struct bnx2x, timer);
#else
static void bnx2x_timer(unsigned long data)
{
	...
	if (IS_PF(bp) &&
		...
		/* If reset in progress is set by any func on an engine,
		 * other PFs from the engine will also initiate and
	...
	if (BNX2X_STATE_OPEN_OR_EXPLICIT_LB(bp))
		bnx2x_stats_handle(bp, STATS_EVENT_UPDATE, false);
...
#if defined(__VMKLNX__) /* ! BNX2X_UPSTREAM */
	if (!bp->esx.error_status && bp->esx.tx_to_delay)
		bnx2x_detect_tx_hang(bp);
#endif
			    ...
			    unsigned long *tx_accept_flags)
{
	...
	*tx_accept_flags = 0;
	...
	case BNX2X_RX_MODE_ALLMULTI:
		 ...
		 * level  */
		if (IS_VLAN_FILTER(bp))
			__set_bit(BNX2X_ACCEPT_ALL_UNICAST, rx_accept_flags);
		else
	...
	case BNX2X_RX_MODE_PROMISC:
		...
		if (full_promiscous) {
			DP(NETIF_MSG_IFUP, "Full promiscous mode is on\n");
			__set_bit(BNX2X_ACCEPT_ALL_UNICAST, rx_accept_flags);
			__set_bit(BNX2X_ACCEPT_ALL_UNICAST, tx_accept_flags);
		}
...
static int bnx2x_del_all_vlans(struct bnx2x *bp)
{
	...
	struct bnx2x_vlan_mac_obj *pvlan_obj = &bp->sp_objs[0].pvlan_obj;
	...
	if (IS_VLAN_FILTER(bp) && BP_PVID(bp)) {
		rc = pvlan_obj->delete_all(bp, pvlan_obj, &vlan_flags,
					   &ramrod_flags);
		if (rc)
			return rc;

		bp->vlan_mode_info.pvid_hw = false;
	}
...
static void bnx2x_recovery_failed(struct bnx2x *bp)
{
	...
	/* Mark link down */
	bnx2x_tx_disable(bp);
	BNX2X_ERR("ESX_REC_FAIL DS:0x%x RS:%d ES:0x%x\n",
		  bp->state, bp->recovery_state, bp->esx.error_status);
#else
 ...
 */
_UP_STATIC void bnx2x_parity_recover(struct bnx2x *bp)
{
	bool global = false;
				...
				if (!bnx2x_reset_is_done(bp, BP_PATH(bp))) {
					...
					if (bnx2x_nic_load(bp, LOAD_NORMAL)) {
						...
						bp->recovery_state =
							BNX2X_RECOVERY_DONE;
#if  defined(__VMKLNX__) /* ! BNX2X_UPSTREAM */
						BNX2X_ERR("ESX_REC_DONE DS:0x%x ES:0x%x\n",
							  bp->state, bp->esx.error_status);
						bp->esx.error_status = 0;
#else
						BNX2X_STOP_RECOVERY(bp);
#endif
						error_recovered++;
						smp_mb();
					}
...
#if defined(CONFIG_BNX2X_VXLAN) || defined(CONFIG_BNX2X_GENEVE) || HAS_NDO(UDP_TUNNEL_CONFIG) || defined(__VMKLNX__) /* BNX2X_UPSTREAM */
_UP_STATIC int bnx2x_udp_port_update(struct bnx2x *bp)
{
	struct bnx2x_func_switch_update_params *switch_update_params;
	struct bnx2x_func_state_params func_params = {NULL};
...
#if HAS_NDO(UDP_TUNNEL_CONFIG) /* BNX2X_UPSTREAM */
...
#ifdef CONFIG_BNX2X_VXLAN /* ! BNX2X_UPSTREAM */
...
static void bnx2x_sp_rtnl_task(void *data)
{
	...
	if (test_and_clear_bit(BNX2X_SP_RTNL_OEM_EVENT, &bp->sp_rtnl_state)) {
		if (CHIP_IS_E3(bp) && IS_MF(bp)) {
			bool mf_dis, llh_en;

			DP(NETIF_MSG_IFUP, "reading mf_cfg to handle oem events\n");
			bnx2x_read_mf_cfg(bp);

			mf_dis = bp->mf_config[BP_VN(bp)] & FUNC_MF_CFG_FUNC_DISABLED;
			llh_en = REG_RD(bp, NIG_REG_LLH0_FUNC_EN + BP_PORT(bp)*8);

			if (!mf_dis && !llh_en) {
				bp->flags &= ~MF_FUNC_DIS;
				bnx2x_e1h_enable(bp);
				DP(NETIF_MSG_IFUP, "mf_cfg function enabled\n");
			} else if (mf_dis && llh_en) {
				bp->flags |= MF_FUNC_DIS;
				bnx2x_e1h_disable(bp);
				DP(NETIF_MSG_IFUP, "mf_cfg function disabled\n");
			}
...
#if defined(CONFIG_BNX2X_VXLAN) || defined(CONFIG_BNX2X_GENEVE) || HAS_NDO(UDP_TUNNEL_CONFIG) /* BNX2X_UPSTREAM */
...
bnx2x_get_vlan_mode_hwinfo(struct bnx2x *bp)
{
	struct nvm_vlan_table_image *image = NULL;
	struct bnx2x_vlan_entry *vlan;
	struct pf_vlan_table *table;
	u32 offset, size, *ptr;
	int rc, i, j, bit_count;
	u8 vl_mode;
	u16 vid;

	memset(&bp->vlan_mode_info, 0, sizeof(bp->vlan_mode_info));

	/* Set default VLAN mode. */
	bp->vlan_mode_info.vlan_mode = BNX2X_VLAN_MODE_NORMAL;

	if (bp->mf_mode != SINGLE_FUNCTION &&
	    bp->mf_mode != MULTI_FUNCTION_SI) {
		pr_info("Adapter mode is 0x%x, discarding VLAN config\n",
			bp->mf_mode);
		return;
	}

	/* Read VLAN table offset. */
	rc = bnx2x_fw_command(bp, DRV_MSG_CODE_IMG_OFFSET_REQ,
			      DRV_MSG_CODE_VLAN_TABLE_IMAGE_REQ);
	if (!rc) {
		BNX2X_ERROR("Failed to get vlan table offset\n");
		return;
	}

	offset = SHMEM_RD(bp, func_mb[BP_FW_MB_IDX(bp)].fw_mb_param);
	if (offset == FW_PARAM_INVALID_IMG) {
		BNX2X_DEV_INFO("Vlan partition is not present or corrupted\n");
		return;
	}

	/* Read VLAN table size. */
	rc = bnx2x_fw_command(bp, DRV_MSG_CODE_IMG_SIZE_REQ,
			      DRV_MSG_CODE_VLAN_TABLE_IMAGE_REQ);
	if (!rc) {
		BNX2X_ERROR("Failed to get vlan table size\n");
		return;
	}

	size = SHMEM_RD(bp, func_mb[BP_FW_MB_IDX(bp)].fw_mb_param);
	if (size == FW_PARAM_INVALID_IMG) {
		BNX2X_DEV_INFO("Vlan partition is not present or corrupted\n");
		return;
	}
	...
	if (!image) {
		BNX2X_ERROR("Failed vlan image allocation:%d\n", size);
		return;
	}

	/* Read the vlan table from nvram */
	if (bnx2x_nvram_read(bp, offset, (u8 *)image, size)) {
		BNX2X_ERROR("Failed to read vlan table image\n");
		goto out;
	}
	...
	table = &image->vlan_table.pf_vlans[bp->pf_num];
	vl_mode = image->vlan_table.vlan_mode[BP_PATH(bp)][BP_PORT(bp)];

	/* Get VLAN mode */
	switch (vl_mode) {
	case VLAN_MODE_NORMAL:
		/* Do Nothing. */
		goto out;
	case VLAN_MODE_FILTER:
		bp->vlan_mode_info.vlan_mode = BNX2X_VLAN_MODE_FILTER;
		break;
	case VLAN_MODE_QINQ:
		bp->vlan_mode_info.vlan_mode = BNX2X_VLAN_MODE_QINQ;
		break;
	default:
		BNX2X_ERROR("Invalid vlan mode %d\n", vl_mode);
		goto out;
	}

	/* Get PVID */
	bp->vlan_mode_info.pvid = table->pvid;
	bp->vlan_mode_info.pcp = table->pcp;

	if (IS_VLAN_QINQ(bp))
		goto out;

	/* Create a list of designated VLAN ids */
	bit_count = sizeof(table->trunk_vlan_bitmap[0]) * 8;

	for (i = 0; i < VLAN_BITMAP_SIZE; i++) {
		for (j = 0; j < bit_count; j++) {
			if (!(table->trunk_vlan_bitmap[i] & BIT(j)))
				continue;

			vid = (i * bit_count) + j;

			/* Discard, if PVID is found again. */
			if (vid == BP_PVID(bp))
				continue;

			vlan = kmalloc(sizeof(*vlan), GFP_KERNEL);
			if (!vlan) {
				BNX2X_ERROR("Failed to allocate vlan entry\n");
				goto out;
			}
...
out:
	...
	pr_info("%s %d:%d:%d m:%d vlan_mode:%d pvid:%d pcp = %d\n", __func__,
		BP_PATH(bp), BP_PORT(bp), BP_FUNC(bp), bp->mf_mode,
		bp->vlan_mode_info.vlan_mode, BP_PVID(bp),
		bp->vlan_mode_info.pcp);
	return;
}
...
static void __devinit bnx2x_set_modes_bitmap(struct bnx2x *bp)
{
	...
	/* QinQ needs MF_SD to be set, irrespective of actual mode. */
	if (IS_VLAN_QINQ(bp))
		SET_FLAGS(flags, (MODE_MF | MODE_MF_SD));
	else if (IS_MF(bp)) {
...
{
#ifdef _HAS_NDO_FEATURES_VLAN_CHECK /* BNX2X_UPSTREAM */
	features = vlan_features_check(skb, features);
#endif
#ifdef _HAS_NDO_FEATURES_VXLAN_CHECK /* BNX2X_UPSTREAM */
...
static int __bnx2x_vlan_configure_pvid(struct bnx2x *bp, u16 vid, bool add)
{
	int rc;
	...
	if (IS_PF(bp)) {
		...
		__set_bit(RAMROD_COMP_WAIT, &ramrod_flags);
		rc = bnx2x_set_vlan_one(bp, vid, &bp->sp_objs->pvlan_obj,
				add, &ramrod_flags);
	} else {
		rc = -EINVAL;
	}
...
static void __bnx2x_configure_qinq(struct bnx2x *bp)
{
	int port = BP_PORT(bp);

	/* Configure PVID in NIG. */
	REG_WR(bp, port ? NIG_REG_LLH1_FUNC_EN :
			NIG_REG_LLH0_FUNC_EN, 1);

	REG_WR(bp, NIG_REG_LLH0_FUNC_VLAN_ID + port * 8, BP_PVID(bp));

	/* Configure QinQ mode. */
	REG_WR(bp, (port ? NIG_REG_LLH1_CLS_TYPE :
				NIG_REG_LLH0_CLS_TYPE), 1);

	REG_WR(bp, port ? NIG_REG_LLH1_MF_MODE :
			NIG_REG_LLH_MF_MODE, 1);

	REG_WR(bp, NIG_REG_LLH_E1HOV_MODE, 1);

	REG_WR(bp, NIG_REG_LLH_E1HOV_TYPE_1, ETH_P_8021Q);

	REG_WR(bp, port ? NIG_REG_LLH1_BRB1_DRV_MASK_MF :
			NIG_REG_LLH0_BRB1_DRV_MASK_MF, 0x3);

	/* overwrite previous value, if any. */
	REG_WR(bp, port ? NIG_REG_P1_HDRS_AFTER_BASIC :
			NIG_REG_P0_HDRS_AFTER_BASIC, 0x7);
	REG_WR(bp, PBF_REG_HDRS_AFTER_BASIC, 0x7);

	if (CHIP_IS_E3B0(bp)) {
		REG_WR(bp, port ?  PRS_REG_HDRS_AFTER_BASIC_PORT_1 :
				PRS_REG_HDRS_AFTER_BASIC_PORT_0, 0x7);

		REG_WR(bp, port ? PRS_REG_MUST_HAVE_HDRS_PORT_1 :
				PRS_REG_MUST_HAVE_HDRS_PORT_0, 0x1);
	}

	if (CHIP_IS_E3A0(bp)) {
		REG_WR(bp, PRS_REG_HDRS_AFTER_BASIC, 0x7);
		REG_WR(bp, PRS_REG_MUST_HAVE_HDRS, 0x1);
	}
...
static int bnx2x_vlan_configure_vid_list(struct bnx2x *bp)
{
	...
	/* Configure QinQ Mode. */
	if (IS_VLAN_QINQ(bp)) {
		__bnx2x_configure_qinq(bp);
		DP(NETIF_MSG_IFUP, "HW configured QinQ PVID %d\n", BP_PVID(bp));
		return 0;
	}

	/* Configure PVID for VLAN-Filter Mode. */
	if (IS_VLAN_FILTER(bp) && BP_PVID(bp) &&
	    !bp->vlan_mode_info.pvid_hw) {
		rc = __bnx2x_vlan_configure_pvid(bp, BP_PVID(bp), true);

		if (rc) {
			BNX2X_ERR("Failed to config PVID %d\n", BP_PVID(bp));
			return rc;
		}

		DP(NETIF_MSG_IFUP, "HW configured PVID %d\n", BP_PVID(bp));
		bp->vlan_mode_info.pvid_hw = true;
		bp->vlan_cnt++;
	}
	...
	list_for_each_entry(vlan, &bp->vlan_reg, link) {
		...
		if (!IS_VLAN_FILTER(bp) && (bp->vlan_cnt >= bp->vlan_credit))
			return -ENOBUFS;
...
static void bnx2x_vlan_configure(struct bnx2x *bp, bool set_rx_mode)
{
	...
	if (IS_VLAN_QINQ(bp))
		need_accept_any_vlan = 1;

#ifndef BNX2X_UPSTREAM /* ! BNX2X_UPSTREAM */
	/* Only re-configure flow done via nic_load() would call this with
	 * `set_rx_mode == false'. In upstream when this was done it was
	 * guaranteed that ndo_set_rx_mode() would be called afterwards,
	 * so there's no need to explicitly change rx_mode here. This is
	 * probably true for all distros, but no reason to take any risks.
	 */
	set_rx_mode = true;
#endif
...
{
#if defined(__VMKLNX__) /* ! BNX2X_UPSTREAM */
	/* No VLAN filters in normal mode. */
	if (IS_VLAN_NORMAL(bp))
		return 0;
#endif
...
static int bnx2x_vlan_rx_add_vid(struct net_device *dev, __be16 proto, u16 vid)
{
	...
	if (!IS_VLAN_NORMAL(bp)) {
		DP(NETIF_MSG_IFUP,
		   "Hardware confiiguration is not allowed in the vlan mode %d\n",
		   bp->vlan_mode_info.vlan_mode);
		return -EINVAL;
	}
...
#ifdef _HAS_NDO_SIZE_EXT_OPS /* ! BNX2X_UPSTREAM */
...
#ifndef _HAS_NDO_EXT_CHANGE_MTU /* BNX2X_UPSTREAM */
...
#endif
#ifdef BCM_MULTI_COS /* BNX2X_UPSTREAM */
#if defined(_HAS_TC_SETUP_TYPE) || defined(_HAS_NDO_SETUP_TC_HANDLE) /* BNX2X_UPSTREAM */
#ifndef _HAS_NDO_EXT_SETUP_TC /* BNX2X_UPSTREAM */
...
#ifndef _HAS_NDO_EXT_VF_VLAN_PROTO /* BNX2X_UPSTREAM */
...
#endif
#ifdef _HAS_SET_VF_SPOOFCHK /* BNX2X_UPSTREAM */
...
#endif
#ifdef _HAS_NDO_UDP_TUNNEL_CONFIG /* BNX2X_UPSTREAM */
...
#endif
#if defined(_HAS_NDO_EXT_VF_VLAN_PROTO) || defined(_HAS_NDO_EXT_UDP_TUNNEL_CONFIG) || defined(_HAS_NDO_EXT_CHANGE_MTU) || defined(_HAS_NDO_EXT_SETUP_TC) /* ! BNX2X_UPSTREAM */
	.extended = {
#ifdef BNX2X_COMPAT_VF_NDO
#ifdef CONFIG_BNX2X_SRIOV
		...
		.ndo_change_mtu = bnx2x_change_mtu,
#endif
#ifdef _HAS_NDO_EXT_UDP_TUNNEL_CONFIG
		.ndo_udp_tunnel_add = bnx2x_udp_tunnel_add,
		.ndo_udp_tunnel_del = bnx2x_udp_tunnel_del,
#endif
		...
		.ndo_setup_tc_rh = __bnx2x_setup_tc,
#endif
#endif
	},
#endif
...
#ifdef _HAS_CALLBACK_TIMESPEC64 /* BNX2X_UPSTREAM */
						...
						struct net_device *dev)
{
	...
	if (IS_VLAN_NORMAL(bp)) {
		...
		} else if (bp->acquire_resp.pfdev_info.pf_cap &
...
#ifdef NETIF_F_GSO_PARTIAL /* BNX2X_UPSTREAM */
		hw_features |= NETIF_F_GSO_GRE_CSUM |
			       NETIF_F_GSO_UDP_TUNNEL_CSUM |
			       NETIF_F_GSO_PARTIAL;
		dev->hw_enc_features |= NETIF_F_GSO_GRE_CSUM |
					NETIF_F_GSO_UDP_TUNNEL_CSUM |
					NETIF_F_GSO_PARTIAL;
				    ...
				    const struct pci_device_id *ent)
{
	...
	struct bnx2x *bp;
#if (LINUX_VERSION_CODE < KERNEL_VERSION(4, 18, 0)) /* ! BNX2X_UPSTREAM */
	 ...
	 */
	if (is_kdump_kernel()) {
#ifdef _HAS_BOOTTIME /* BNX2X_UPSTREAM */
...
#else
		/* This might sleep for quite a bit if we're in MF mode.... */
		msleep(5000);
#endif
}
#endif
	...
	bp->msg_enable = debug;
	bp->internal_trace.size = int_debug_size;
	bp->internal_trace.level = int_debug;
	pr_info("internal trace size 0x%x, level 0x%x\n",
		int_debug_size, int_debug);
	/* Check here and fail probe */
	if (int_debug != BNX2X_MSG_OFF) {
		bp->internal_trace.buf = kzalloc(int_debug_size, GFP_KERNEL);
		if (!bp->internal_trace.buf) {
			pr_err("Failed to allocate internal trace buf\n");
			free_netdev(dev);
			return -ENOMEM;
		}
	}
...
#if !defined(CONFIG_BNX2X_VXLAN) && !defined(__VMKLNX__) /* ! BNX2X_UPSTREAM */
	bp->udp_tunnel_ports[BNX2X_UDP_PORT_VXLAN].count = 1;
	bp->udp_tunnel_ports[BNX2X_UDP_PORT_VXLAN].dst_port = 8472;
#endif

	if (IS_PF(bp))
		bnx2x_dbg_pf_init(bp);
...
static void __bnx2x_remove(struct pci_dev *pdev,
			   ...
			   bool remove_netdev)
{
	struct bnx2x_vlan_entry *vlan, *tmp;
	...
	/* Free any allocated vlan entries. */
	list_for_each_entry_safe(vlan, tmp, &bp->vlan_reg, link) {
		list_del(&vlan->link);
		kfree(vlan);
	}
...
#ifdef _HAS_CLEANUP_AER_ERROR /* ! BNX2X_UPSTREAM */
...
static int bnx2x_get_sfp_diagnostic(struct net_device *dev,
				    struct sfp_diagnostic *data)
{
	struct bnx2x *bp = netdev_priv(dev);
	int phy_idx, rc, cfg_idx;
	__be16 field;
	...
	rc = bnx2x_read_sfp_module_eeprom(&bp->link_params.phy[phy_idx],
					  &bp->link_params,
					  I2C_DEV_ADDR_A2,
					  SFP_EEPROM_A2_TEMPERATURE_ADDR,
					  SFP_EEPROM_A2_TEMPERATURE_SIZE,
					  (__force u8 *)&field);
	if (rc)
		goto out;
	data->temperature = be16_to_cpu(field);

	rc = bnx2x_read_sfp_module_eeprom(&bp->link_params.phy[phy_idx],
					  &bp->link_params,
					  I2C_DEV_ADDR_A2,
					  SFP_EEPROM_A2_VCC_ADDR,
					  SFP_EEPROM_A2_VCC_SIZE,
					  (__force u8 *)&field);
	if (rc)
		goto out;
	data->vcc = be16_to_cpu(field);

	rc = bnx2x_read_sfp_module_eeprom(&bp->link_params.phy[phy_idx],
					  &bp->link_params,
					  I2C_DEV_ADDR_A2,
					  SFP_EEPROM_A2_TX_BIAS_ADDR,
					  SFP_EEPROM_A2_TX_BIAS_SIZE,
					  (__force u8 *)&field);
	if (rc)
		goto out;
	data->tx_bias = be16_to_cpu(field);

	rc = bnx2x_read_sfp_module_eeprom(&bp->link_params.phy[phy_idx],
					  &bp->link_params,
					  I2C_DEV_ADDR_A2,
					  SFP_EEPROM_A2_TX_POWER_ADDR,
					  SFP_EEPROM_A2_TX_POWER_SIZE,
					  (__force u8 *)&field);
	if (rc)
		goto out;
	data->tx_power = be16_to_cpu(field);

	rc = bnx2x_read_sfp_module_eeprom(&bp->link_params.phy[phy_idx],
					  &bp->link_params,
					  I2C_DEV_ADDR_A2,
					  SFP_EEPROM_A2_RX_POWER_ADDR,
					  SFP_EEPROM_A2_RX_POWER_SIZE,
					  (__force u8 *)&field);
	if (rc)
		goto out;
	data->rx_power = be16_to_cpu(field);
	...
	data->speed_cap = bp->link_params.speed_cap_mask[cfg_idx];

	/* TODO - fill-in the speed-cap [not sure of the right format] */
	if (BNX2X_STATE_OPEN_OR_EXPLICIT_LB(bp) && bp->link_vars.link_up &&
	    !(bp->flags & MF_FUNC_DIS)) {
		if (IS_MF(bp) && !BP_NOMCP(bp))
			data->opr_speed = bnx2x_get_mf_speed(bp);
		else
			data->opr_speed = bp->link_vars.line_speed;
	} else {
		data->opr_speed = 0;
	}
...
static int bnx2x_get_link_error(struct net_device *dev,
				struct link_error_status *data)
{
	struct bnx2x *bp = netdev_priv(dev);
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 24)) || defined(__VMKLNX__) /* BNX2X_UPSTREAM */
	...
	data->inval_crc_cnt = nstats->rx_crc_errors;

	return 0;
}
#endif

bool bnx2x_is_nvm_accessible(struct bnx2x *bp)
{
	int rc = 1;
	u16 pm = 0;
...
_UP_STATIC struct cnic_eth_dev *bnx2x_cnic_probe(struct net_device *dev)
{
	...
	cp->drv_get_sfp_diagnostic = bnx2x_get_sfp_diagnostic;
	cp->drv_get_link_error = bnx2x_get_link_error;
#endif
...
static void bnx2x_ptp_task(struct work_struct *work)
{
	...
	timedout = time_is_before_jiffies(bp->ptp_tx_start +
					  BNX2X_PTP_TX_TIMEOUT);
	...
	if (val_seq & 0x10000) {
		...
		if (unlikely(timedout)) {
			DP(BNX2X_MSG_PTP, "Tx timestamp is not recorded\n");
			dev_kfree_skb_any(bp->ptp_tx_skb);
			bp->ptp_tx_skb = NULL;
			bp->eth_stats.ptp_skip_txts++;
		} else {
			/* Reschedule to keep checking for valid tstamp value */
...
/* Read the PHC */
#ifdef _HAS_REMOVED_CYCLE_T /* BNX2X_UPSTREAM */
...
#define BNX2X_PTP_UCAST_MASK 0x70F
#define BNX2X_PTP_TX_ON_PARAM_MASK ((BNX2X_P2P_DETECT_PARAM_MASK & 0x6AA) | BNX2X_PTP_UCAST_MASK)
#define BNX2X_PTP_TX_ON_RULE_MASK (BNX2X_P2P_DETECT_RULE_MASK & 0x3EEE)
#define BNX2X_PTP_V1_L4_PARAM_MASK ((BNX2X_P2P_DETECT_PARAM_MASK & 0x7EE) | BNX2X_PTP_UCAST_MASK)
#define BNX2X_PTP_V1_L4_RULE_MASK (BNX2X_P2P_DETECT_RULE_MASK & 0x3FFE)
#define BNX2X_PTP_V2_L4_PARAM_MASK ((BNX2X_P2P_DETECT_PARAM_MASK & 0x7EA) | BNX2X_PTP_UCAST_MASK)
#define BNX2X_PTP_V2_L4_RULE_MASK (BNX2X_P2P_DETECT_RULE_MASK & 0x3FEE)
#define BNX2X_PTP_V2_L2_PARAM_MASK ((BNX2X_P2P_DETECT_PARAM_MASK & 0x6BF) | BNX2X_PTP_UCAST_MASK)
#define BNX2X_PTP_V2_L2_RULE_MASK (BNX2X_P2P_DETECT_RULE_MASK & 0x3EFF)
#define BNX2X_PTP_V2_PARAM_MASK ((BNX2X_P2P_DETECT_PARAM_MASK & 0x6AA) | BNX2X_PTP_UCAST_MASK)
...
static int bnx2x_configure_ptp(struct bnx2x *bp)
{
	...
	REG_WR(bp, port ? NIG_REG_P1_LLH_PTP_PARAM_MASK :
	       NIG_REG_P0_LLH_PTP_PARAM_MASK, BNX2X_PTP_UCAST_MASK);
	REG_WR(bp, port ? NIG_REG_P1_LLH_PTP_RULE_MASK :
	       NIG_REG_P0_LLH_PTP_RULE_MASK, 0x3DBB);
	REG_WR(bp, port ? NIG_REG_P1_TLLH_PTP_PARAM_MASK :
	       NIG_REG_P0_TLLH_PTP_PARAM_MASK, BNX2X_PTP_UCAST_MASK);
	REG_WR(bp, port ? NIG_REG_P1_TLLH_PTP_RULE_MASK :
	       NIG_REG_P0_TLLH_PTP_RULE_MASK, 0x3DBB);
...
/* Internal trace append message */
void bnx2x_dp_internal_log(struct bnx2x *bp, char *fmt, ...)
{
	char buff[BNX2X_INT_DBG_LOG_MAX_STR_SIZE];
	struct bnx2x_internal_trace *p_int_log;
	struct bnx2x_timestamp ts;
	...
	/* Insert timestamp */
	bnx2x_get_ts(&ts);
	if (ts.sec || ts.rem_usec)
		len += sprintf(&buf[0], "[%5llu.%06lu] ", ts.sec, ts.rem_usec);

	va_start(args, fmt);
	len += vsnprintf(&buf[len], BNX2X_INT_DBG_LOG_MAX_STR_SIZE - len,
		fmt, args);
	va_end(args);

	/* If incoming msg was bigger than local buff, vsnprintf returns
	 * number of bytes in the msg (> buff size). In this case,
	 * clip the msg to fit inside buff
	 */
	if (len > BNX2X_INT_DBG_LOG_MAX_STR_SIZE) {
		len = BNX2X_INT_DBG_LOG_MAX_STR_SIZE;
		buf[len - 1] = '\n';
	}

	partial_len = len;

	/* Prevent corruption if msg levels related to timers/threads/isr
	 * are enabled for debug purposes
	 */
...
/**
 * Return buffer size in bytes required for internal trace dump
 *
 * @bp: driver handle
 */
u32 bnx2x_dbg_internal_trace_get_dump_size(struct bnx2x *bp)
{
	struct bnx2x_internal_trace *log = &bp->internal_trace;
...
/**
 * Dump the contents of internal trace buffer into output buffer.
 * Size of output buffer in bytes is value returned from
 * bnx2x_dbg_internal_trace_get_dump_size()
 *
 * @bp: driver handle
 * @dump_buf: ptr to output buffer
 * @num_dumped_bytes: on return, no. of bytes in output buffer
 */
void bnx2x_dbg_internal_trace_result(struct bnx2x *bp,
				     u8 *dump_buf,
				     u32 *num_dumped_bytes)
{
	...
	BNX2X_ERR("Collecting debug internal trace dump\r\n");

	*num_dumped_bytes = 0;

	/* Acquire lock to prevent reading from unfinished
	 * updates to the log
	 */
	spin_lock_bh(&log->lock);

	/* copy buf from prod to size then from 0 to prod */
	memcpy(char_buf, log->buf + (log->prod % log->size),
	       min_t(u64, log->prod, log->size) - (log->prod % log->size));

	memcpy(char_buf, log->buf, log->prod % log->size);

	if (log->prod >= log->size)
		*num_dumped_bytes = log->size;
	else
	*num_dumped_bytes = (u32)log->prod;
