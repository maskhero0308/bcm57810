...
/* signal_pending() and flush_signal() moved to a new header file in 4.11 */
...
#define BNX2FC_VERSION		"2.12.17"
#define BNX2FC_RELDATE		"October 2, 2021"
...
struct bnx2fc_hba_dbg_stats {
	...
	u32 lun_resets;
	u32 fc_eof_a;
	u32 drop_d_id_mismatch;
	u32 drop_fpma_mismatch;
	u32 drop_wrong_source_mac;
	u32 drop_abts_seq_ex_ctx_set;
	u32 drop_lport_d_id_mismatch;
};
...
#if (defined(__BNX2FC_SLES__) && (__BNX2FC_SLES__ == 0x1104))
	struct work_struct static_npiv_work;
#endif
	struct kref kref;
...
#define bnx2fc_to_ctlr(ifx) (&(ifx)->ctlr)
#endif
...
void bnx2fc_process_cq_compl(struct bnx2fc_rport *tgt, u16 wqe,
		unsigned char *rq_data, u8 num_rq, struct fcoe_task_ctx_entry *task);
...
extern void bnx2fc_flogi_resp(struct fc_seq *, struct fc_frame *,
	void *arg);
